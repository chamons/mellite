...
# "ARKit" "AVFoundation" "AVKit" "Accelerate" "Accessibility" "Accounts" "AdSupport" "AddressBook" "AddressBookUI" 
# "AppKit" "AssetsLibrary" "AudioToolbox" 
# "AudioUnit" "AuthenticationServices" "BackgroundTasks" "BusinessChat" "CFNetwork" "CallKit" "CarPlay" "Carbon" "Chip" "ClassKit" "ClockKit" "CloudKit" "Compression" "Contacts" "CoreAnimation" "CoreBluetooth" "CoreData" "CoreFoundation" "CoreGraphics" "CoreHaptics" "CoreImage" "CoreLocation" "CoreML" "CoreMedia" "CoreMidi" "CoreMotion" "CoreServices" "CoreSpotlight" "CoreTelephony" "CoreText" "CoreVideo" "CoreWlan" "Darwin" "EventKit" "EventKitUI" "ExternalAccessory" "FileProvider" "FinderSync"
#  "Foundation" "GLKit" "GameController" "GameKit" "GameplayKit" "HealthKit" 
# "HomeKit" "IOSurface" "ImageCaptureCore" "ImageIO" "ImageKit" "InputMethodKit" "Intents" "JavaScriptCore" "LocalAuthentication" "MLCompute" "MapKit" "MediaAccessibility" "MediaLibrary" "MediaPlayer" "MediaToolbox" "MessageUI"
...
#  "UIKit" "UserNotifications" "VideoSubscriberAccount" "VideoToolbox" "Vision" "WKWebKit" "WatchConnectivity" "WatchKit" "WebKit" "XKit" "iAd" "iTunesLibrary""
# 
declare -a apis=("AppKit")
